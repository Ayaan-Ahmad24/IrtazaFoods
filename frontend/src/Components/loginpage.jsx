    ...
    return (
        <div className="bg-gray-100 min-h-screen mt-32">
            ...
            <main className="container mx-auto py-10 px-4">
                <h1 className="text-4xl font-bold mb-8 text-yellow-600 text-center">Admin Login</h1>
                <form onSubmit={handleLogin} className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
                    ...
                    <button type="submit" className="bg-yellow-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-yellow-600">
                        Login
                    </button>
                </form>
            </main>
