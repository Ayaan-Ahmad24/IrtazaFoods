...
const updateBlog = async ({ id, updatedBlog }) => {
    await axios.put(`http://localhost:5000/api/blog/update/${id}`, updatedBlog);
};
...
const EditBlogPage = () => {
    ...
    if (isLoading) return <div className="bg-gray-100 min-h-screen py-12 px-4 text-center">Loading...</div>;
    if (error) return <div className="bg-gray-100 min-h-screen py-12 px-4 text-center">Error loading blog: {error.message}</div>;
        ...
        <div className="flex min-h-screen">
            ...
            <div className="bg-gray-100 min-h-screen py-12 px-4 mt-32 flex-1">
                <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                    <h2 className="text-2xl font-bold mb-4 text-yellow-600">Edit Blog Post</h2>
                    {blog ? (
